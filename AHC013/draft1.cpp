...
void field_move(int N, int K, Field &field, int partition_idx) {
    ...
    rep(i, K) {
        ...
        // dbg(move_range_left); 
        // dbg(move_range_right);
        // dbg(not_move_range_left);
        // dbg(not_move_range_right);
...
void field_connect(int N, int K, Field &field, int partition_idx) {
    ...
    int connect_counter = 60 * K + move_counter;
    ...
    rep(idx, K) {
        ...
        rep(i1, N) {
            rep(j1, not_move_range_left, not_move_range_right) {
                // 右
                rep(j2, j1, not_move_range_right) {
...
int main() {
    ...
    cerr << "--ans--\n\n";
    cerr << "total size " <<  output_move.size() + output_connect.size() << "\n";
